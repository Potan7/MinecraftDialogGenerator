...
public class FlexibleVariableConverter<T> : JsonConverter
{
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
    {
        ...
        throw new JsonSerializationException($"Unexpected JSON token type: {token.Type}. Expected Object, Array or Null.");
    }
